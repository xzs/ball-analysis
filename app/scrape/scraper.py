...
get_player_log(PLAYERS_DICT['CHI'])
get_player_log(PLAYERS_DICT['ATL'])
get_player_log(PLAYERS_DICT['DEN'])
get_player_log(PLAYERS_DICT['DAL'])
get_player_log(PLAYERS_DICT['LAC'])
get_player_log(PLAYERS_DICT['SAC'])
get_player_log(PLAYERS_DICT['MEM'])
get_player_log(PLAYERS_DICT['LAL'])
